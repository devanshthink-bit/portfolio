  ...
  return (
    <section className="intro">
      ...
      <div className="intro-body">
        <p>
          Hey, I am Devansh. A product designer, with a background in engineering where I spent three years shipping 0→1 flagship products used by millions across greentech, workforce enablement, and hospitality, at both startups and scale.
        </p>
        <p>
