...
export const T = {
  h1:      { fontFamily: MANROPE, fontSize: 28, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.03em", lineHeight: 1.15, margin: "0 0 12px 0" } as React.CSSProperties,
  ...
  sub:     { fontFamily: INTER, fontSize: 16, fontWeight: 400, color: "var(--text-secondary)", letterSpacing: "-0.011em", lineHeight: 1.6, margin: 0, maxWidth: 640 } as React.CSSProperties,
  ...
  body:    { fontFamily: INTER, fontSize: 16, fontWeight: 400, color: "var(--text-secondary)", letterSpacing: "-0.011em", lineHeight: 1.6, margin: 0 } as React.CSSProperties,
  ...
  figure:  { fontFamily: MANROPE, fontSize: 28, fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.15, color: "var(--text-primary)", fontVariantNumeric: "tabular-nums" } as React.CSSProperties,
};
