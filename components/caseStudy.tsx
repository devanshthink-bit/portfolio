...
export const T = {
  ...
  lede:    { fontFamily: INTER, fontSize: 20, fontWeight: 500, color: "var(--text-secondary)", letterSpacing: "-0.02em", lineHeight: 1.5, margin: "0 0 36px 0", maxWidth: 620 } as React.CSSProperties,
