...
function Solar({ body }: { body: string }) {
  return <svg width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden dangerouslySetInnerHTML={{ __html: body }} />;
}
  ...
  return (
    <nav
      ...
      style={{
        ...
        zIndex: 1000, display: "flex", gap: 24, alignItems: "center",
        background: "#2e2e2e", padding: "16px 22px", borderRadius: 100,
      }}
    >
