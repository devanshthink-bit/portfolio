    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 96, marginTop: 24 }}>
      ...
      <div className="section">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24, marginTop: 32 }}>
          <h2 style={{ fontFamily: "var(--font-manrope), sans-serif", fontSize: "var(--fs-28)", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.2, color: "var(--text-primary)", margin: 0 }}>Designing with craft, building with code.</h2>
