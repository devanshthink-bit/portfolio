...
const recentWork = [
  ...
  // },
  {
    ...
    blurb: "Most people booking a one-way bus ticket don't know when they'll come back, so they skip the return and often book it somewhere else later. I redesigned RedBus checkout so they can book the return right there, even without a date, and pick the day later.",
  },
  // Hidden for now at Devansh's request (13 Sep 2026). Kept, not deleted: uncomment to bring back.
  // {
  //   title: "Case Study 3",
